                ...
                <div class="md:flex -mx-4">
                    <div class="md:w-2/3 px-4">
                        ...
                        <heading class="mb-4">
                            ...
                            <link-to
                                :to="`/jobs?category=${post.job_category}`"
                                >{{ post.job_category }}</link-to
                            >
                        </heading>
                    ...
                    >
                        ...
                        <div>
                            <div
                                class="flex md:w-64 items-center mt-2 -mb-3 justify-center"
                            >
                                <div
                                ...
                                >
                                    <div class="flex justify-between">
                                        <network network="facebook">
                                            <div
                                                class="cursor-pointer p-2 rounded-full bg-facebook text-white mr-2"
                                            >
                                                <svg
                                        ...
                                        <network network="linkedin">
                                            <div
                                                class="cursor-pointer p-2 rounded-full bg-linkedin text-white mr-2"
                                            >
                                                <svg
                                                    class="w-5 h-5 fill-current flex-shrink-0"
                                                    xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <network network="whatsapp">
                                            <div
                                                class="cursor-pointer p-2 rounded-full bg-whatsapp text-white mr-2"
                                            >
                                                <svg
                                                    class="w-5 h-5 fill-current flex-shrink-0"
                                                    xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <network network="twitter">
                                            <div
                                                class="cursor-pointer p-2 rounded-full bg-twitter text-white"
                                            >
                                                <svg
                                                    class="w-5 h-5 fill-current flex-shrink-0"
                                                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                        <card class="mb-10 flex-1">
                            <heading size="large" class="mb-4"
                                >About {{ post.company.company_name }}</heading
                            >

                            <div
                                v-if="post.company.company_logo == null"
                                class="mb-4 flex-shrink-0 w-20 h-20 mx-auto"
                            >
                                <avatar
                            ...
                            <div class="my-5">
                                <div
                                    class="py-2 md:flex-1 flex items-center border-b justify-between"
                                >
                                    <heading size="small-caps"
                                        >Industry</heading
                                    >
                                    <heading size="small">{{
