						...
						<div class="md:flex mb-10 -mx-4">
							...
							<div class="md:w-2/3 px-4">
								<card>
									...
									<!-- <label class="form-label block mb-1 font-semibold text-gray-700">Description</label>
									<ckeditor
										:editor="editor"
										v-model="job.job_description"
										:config="editorConfig"
...
export default {
	...
	data() {
		return {
			...
			// 				model: "paragraph",
			// 				title: "Paragraph",
			// 				class: "ck-heading_paragraph mb-2 text-gray-600"
			// 			},
			// 			{
			// 				model: "heading2",
			// 				view: "h2",
			// 				title: "Heading 2",
			// 				class: "ck-heading_heading2 text-gray-700"
			// 			},
			// 			{
			// 				model: "heading3",
			// 				view: "h3",
			// 				title: "Heading 3",
			// 				class: "ck-heading_heading3 text-gray-700"
			// 			}
			// 		]
			// 	}
			// }
