			...
			<div class="max-w-6xl mx-auto">
				<div class="md:flex md:flex-wrap mb-10 -mx-4">
					...
					<div class="md:w-2/3 px-4">
						<card with-footer>
							<text-input class="mb-4" label="Name" v-model="user.name"></text-input>
							<div class="mb-2">
								<text-input label="Email" disabled v-model="user.email" :bordered="false"></text-input>
								<p class="text-sm mb-0 mt-2">
									Please
									<link-to to="#">contact admin</link-to>&nbsp;to change/update your email address
								</p>
							</div>

							<template #footer>
								<loading-button>Update Profile</loading-button>
							</template>
						</card>
					</div>
				</div>
				...
				<div class="md:flex md:flex-wrap mb-10 -mx-4">
					<div class="md:w-1/3 px-4">
						...
						<heading
							class="mb-4"
						>Update your password here. We recommend that you set a strong password that is atleast 8 characters long and includes a mix of letters, numbers and symbols.</heading>
					</div>
					<div class="md:w-2/3 px-4">
						<card with-footer>
							<text-input class="mb-4" label="Current Password"></text-input>
							<text-input class="mb-4" label="New Password"></text-input>
							<text-input label="Confirm New Password"></text-input>
				...
				<div class="md:flex md:flex-wrap mb-10 -mx-4">
					<div class="md:w-1/3 px-4">
						...
						<heading class="mb-4">Control the newsletter subscription and email notifications</heading>
					</div>
					<div class="md:w-2/3 px-4">
						<card :is-padding="false" with-footer>
							<list-group>
								<div slot="listbody" class="pr-10">
									...
									<heading>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla dolorem odit voluptas, saepe a earum.</heading>
								</div>
