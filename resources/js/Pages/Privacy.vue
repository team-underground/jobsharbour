	...
	<layout>
		<div class="px-4 py-6 md:py-16 relative">
			<div class="max-w-5xl mx-auto">
				...
				<heading size="large" class="my-3">Use</heading>
				<p class="mb-2">If you choose to provide us with the above mentioned information, you consent to the use, transfer, processing and storage of the information so provided by you on our servers. The information provided by you shall not be given to third parties (third parties for this purpose do not include our group / holding / subsidiary companies and or our service partners / associates) for marketing purposes and other related activities without your prior consent. Though if you choose to make your profile visible, all information pertaining to your profile will be visible to third parties.</p>
				<p class="mb-2">The information provided by you shall be used by us to:</p>
				<list unordered-list-color="text-blue-600" :lists="['Improve our website and enable us to provide you the most user-friendly experience which is safe, smooth and customized','Improve and customize our services, content and other commercial / non-commercial features on the website','Ask you to send feedback on any or all of our services','Send newsletter(s) to you (Provided you subscribe to the same)','Send you service-related announcements on rare occasions when it is necessary to do so','Contact you or send you e-mail or other communications regarding updates on our website, new job opportunities, services and additional/new job postings/openings which may be of your interest','Provide customer support and the services you request','Avoid/check illegal and/or potentially prohibited activities and to enforce Agreements','Comply with any court judgment / decree / order / directive / legal & government authority /applicable law','Investigate potential violations or applicable national & international laws','Investigate deliberate damage to the website/services or its legitimate operation','Detect, prevent, or otherwise address security and/or technical issues',' The members of our corporate family and group, affiliates, service providers and third parties under a contract to provide joint services, contents and marketing communications']"></list>
				<p class="my-2">If you consent to receive information about third party (such as employers, recruiters or others) opportunities, job opportunities or you make your profile visible we may disclose your information to such third parties for sending you communications via e-mail or otherwise to inform about new opportunities and new job postings/openings which may be of your interest. Also we might use your personal information to communicate with you and ascertain if you are interested in third party services.</p>
				<p class="mb-2">Your information shall be disclosed to our employees/service providers who provide services to us vis-a-vis our website and the services therein. These employees will have access to the information provided by you in order to perform their functions/services efficiently.</p>
				...
				<heading size="large" class="my-3">Changing Your Personal Information</heading>
				<p class="mb-2">You can access and modify your personal information by signing on to the website. We will not modify the information provided by you. However, we recommend that you update your personal information as soon as such changes are necessitated.</p>
				...
				<heading size="large" class="my-3">Account Protection</heading>
				...
				<heading size="large" class="my-3">Changes in this Privacy Statement</heading>
				<p class="mb-2">If we decide to change our privacy policy, we will post those changes to this privacy statement and such other places we deem appropriate so that you are updated about the manner we collect information, what information we collect, how we use it and under what circumstances, if any, we disclose it.</p>
				<p>We reserve the right to modify this privacy statement at any time, so please review it frequently at Jobs Harbour.</p>

				<heading size="large" class="my-3">Contact Us</heading>
				<p>If you have any questions or suggestions regarding our privacy policy, please contact us at:<link-to to="mailto:hello@jobsharbour.com">hello@jobsharbour.com</link-to></p>
