                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="esd-block-text es-p15t es-p10b" align="center">
                                                    <h3 style="font-size: 2.425rem; margin:0; font-weight: 400;">Hi {{$name}}, Thanks</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="esd-block-text es-p15t es-p10b" align="center">
                                                    <p style="letter-spacing: .025rem; margin-bottom: 42px; font-size: 1.25rem;">You have successfully submited a job post. Keep kalm until the verification process is complete.</p>
                                                </td>
                                            </tr>
