          ...
          [
            ...
            _c("div", { staticClass: "md:flex -mx-4" }, [
              ...
              _c(
                ...
                {
                  staticClass:
                    "md:w-1/3 px-4 px-4 md:flex md:flex-col mt-4 md:mt-0"
                },
                [
                  _c(
                    "loading-button",
                          ...
                          directives: [
                            {
                              ...
                              value: _vm.route("jobs.show", _vm.post.job_slug),
                              expression: "route('jobs.show', post.job_slug)",
                              arg: "copy"
                            },
                            {
                              name: "clipboard",
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "flex items-center justify-center md:w-64 border-2 border-gray-300 px-2 pt-4 pb-3 rounded-full"
                    },
                    [
                      _c("social-sharing", {
                        attrs: {
                ...
                [
                  ...
                  _vm.post.company.company_logo == null
                    ...
                    : _c(
                        ...
                        {
                          staticClass:
                            "mb-4 flex-shrink-0 w-20 h-20 rounded-lg bg-gray-100 border block mx-auto"
                        },
                        [
                          _c("img", {
                            staticClass:
