...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      headings: ["Job Title", "Published at", "Total Page Views", "Unique Page Views"]
    };
  }
});
      ...
      _c("div", { staticClass: "md:max-w-6xl mx-auto" }, [
        _c("div", { staticClass: "flex flex-wrap md:justify-center" }, [
          _c(
            ...
            {
              staticClass:
                "w-1/3 md:w-1/6 border-b md:border-transparent py-4 text-center px-4 flex flex-col hover:text-blue-600 items-center justify-center",
              attrs: { href: "/admin/companies" }
            },
            [
              _c("icon", { attrs: { name: "briefcase" } }),
              _vm._v(" "),
              _c("div", { staticClass: "mt-2 mb-1 text-sm" }, [
                _vm._v("Companies")
              ])
            ],
            1
          ...
          _c(
            ...
            {
              staticClass:
                "w-1/3 md:w-1/6 border-l border-b md:border-transparent py-4 text-center px-4 flex flex-col hover:text-blue-600 items-center justify-center",
          ...
          _c(
            ...
            {
              staticClass:
                "w-1/3 md:w-1/6 md:border-transparent py-4 text-center px-4 flex flex-col hover:text-blue-600 items-center justify-center",
              attrs: { href: "/admin/users" }
            },
            [
          ...
          _c(
            ...
            {
              staticClass:
                "w-1/3 md:w-1/6 border-l md:border-transparent py-4 text-center px-4 flex flex-col hover:text-blue-600 items-center justify-center",
              attrs: { href: "/admin/users" }
            },
            [
